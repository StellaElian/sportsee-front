...
export default function ActivityCards() {
    return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '16px', height: '342px' }}>
            ...
            <div style={{
                ...
                width: '572px',       // Ta largeur exacte
                height: '103px',      // Ta hauteur exacte
            ...
            <div style={{
                ...
                <p style={{ margin: 0, fontSize: '14px', fontWeight: '400', color: '#707070' }}>Distance</p>
                <p style={{ margin: 0 }}>
